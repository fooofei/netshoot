...
RUN axel --insecure -q https://github.com/bcicen/ctop/releases/download/v0.7.3/ctop-0.7.3-linux-arm64 -o /usr/local/bin/ctop && chmod +x /usr/local/bin/ctop

# Installing calicoctl
ARG CALICOCTL_VERSION=v3.13.3
RUN axel --insecure -q https://github.com/projectcalico/calicoctl/releases/download/${CALICOCTL_VERSION}/calicoctl-linux-arm64 -o calicoctl && chmod +x calicoctl && mv calicoctl /usr/local/bin

# Installing termshark
ENV TERMSHARK_VERSION 2.1.1
RUN axel --insecure -q https://github.com/gcla/termshark/releases/download/v${TERMSHARK_VERSION}/termshark_${TERMSHARK_VERSION}_linux_armv6.tar.gz -o /tmp/termshark_${TERMSHARK_VERSION}_linux_armv6.tar.gz && \
